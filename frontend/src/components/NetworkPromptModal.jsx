...
export default function NetworkPromptModal({ isOpen, networkName, onDecide, onDismiss }) {
  return (
    <Modal isOpen={isOpen} onClose={onDismiss} className="w-[380px] p-6">
      <div className="flex justify-between items-start mb-5">
        <div>
          <DialogTitle className="text-base font-bold text-[color:var(--c-text-1)] mb-1">New Network Detected</DialogTitle>
