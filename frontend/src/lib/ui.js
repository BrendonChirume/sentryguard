export const card = "glass rounded-2xl shadow-md";
export const modalOverlay = "fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[999]";
export const modalPanel = "glass-strong rounded-2xl shadow-md";
export const cardHover = "glass rounded-2xl shadow-md transition-colors duration-200 hover:bg-[var(--c-surface-3)]";
...
export const btnPrimary = "bg-blue-500/90 text-white border border-blue-400/30 rounded-xl px-4 py-2 text-[13px] font-medium cursor-pointer shadow-md backdrop-blur-sm transition-all duration-150 hover:bg-blue-500";
